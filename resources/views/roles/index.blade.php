					...
					<table class="table table-striped table-bordered">
						...
						@if(count($role)>0)
							...
							<tr>
								...
								<td>
									<a class="btn btn-small btn-primary btn-sm" href="{{ URL::to('admin/roles/'.$value->id) }}">Show</a>

									<a class="btn btn-small btn-info btn-sm" href="{{ URL::to('admin/roles/'.$value->id.'/edit') }}">Edit</a>

									{!! Form::open(array('class' => 'inline_form','method'=>'DELETE','url' =>'admin/roles/'.$value->id)) !!}
							...
							<tr>
								<td colspan="4">
									{!! Form::open(array('method'=>'POST', 'url' =>'admin/roles/delete-all','id' => 'delete_wrapper_form')) !!}
